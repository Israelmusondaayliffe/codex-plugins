#!/usr/bin/env python3
"""
Quick validation script for skills - comprehensive version
...
- Character limits (64 for name, 1024 for description)
...
def validate_skill(skill_path):
    ...
    if name:
        ...
        # Check folder name matches frontmatter name
        if folder_name != name:
            return False, f"Folder name '{folder_name}' does not match frontmatter name '{name}'. They must be identical."
