# Prompting Claude Fable 5 (Official Guide, Verbatim)

Source: Anthropic documentation, "Prompting Claude Fable 5". Preserved verbatim as the ground-truth anchor for this skill. Every agent in this skill derives its guidance from this document. When any other file in this skill conflicts with this document, this document wins.
